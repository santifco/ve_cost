...
with col1:
    ...
    km_viaje = st.number_input("Kilométros de un viaje", min_value=1, value=400, step=10)
...
with col2:
    ...
    with st.container(border=True):
        ...
        with subcol1:
            ...
            st.write(f"Costo total por viaje: **{costo_por_viaje_ve:.2f} $/km**")
        ...
        # Mostrar resultados para vehículo a gasolina
            ...
            st.write(f"Costo total por viaje: **{costo_por_viaje_gas:.2f} $/km**")
    ...
    with st.container(border=True):
        ...
        for km in años:
            ...
            costo_por_km_ev= calcular_costo_total(km, costo_ev, tasa_patentamiento_ev, valor_residual_ev, pago_patente_anual_ev, pago_seguro_anual_ev, mantenimiento_anual_ev, eficiencia_ev, precio_electricidad, "eléctrico")[5]
            costo_por_km_gas= calcular_costo_total(km, costo_gas, tasa_patentamiento_gas, valor_residual_gas, pago_patente_anual_gas, pago_seguro_anual_gas, mantenimiento_anual_gas, eficiencia_gas, precio_gasolina, "gasolina")[5]
